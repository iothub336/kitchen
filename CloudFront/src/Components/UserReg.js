...
function UserReg() {
  ...
  function userRegister() {
    ...
    axios
      .post("http://127.0.0.1:8000/userreg/register/", data)
      .then((res) => {
  ...
  return (
    <div className="container-fluid user-body">
      <div className="col-md-6 pt-5">
        <div className=" shadow p-5 offset-1 ">
          ...
          <div className="card-footer my-3 text-center">
            <button className="btn btn-primary w-100 mb-3" onClick={userRegister}>
              Submit
            </button>
            <Link to="/" className="fw-bold" style={{ textDecoration: "none",color:'black' }}>Alredy Registered ? Login</Link>
          </div>
        </div>
      </div>
    </div>
